...
function Content(props) {
    ...
    const handleLocationInput = (selectedOption) => {
...
lg:px-14'>
    ...
    md:grid md:grid-cols-5'>
                ...
                <div data-wow-duration="1s" data-wow-delay="1s" className='wow fadeInUp px-5 flex flex-col gap-6 bg-white
                    lg:px-14'
                // onClick={jobDescriptionPage}
                >
        ...
        md:grid md:grid-cols-2 md:gap-8'>
...

                            {
                                getFeaturedJobData.map((data) => {
                                    return (
                                        <div key={data._id} className='w-full border border-solid hover:shadow-xl hover:border-[#61CE70] border-gray-300 p-4  flex flex-col gap-4'

...
export default function CandidateDetails({ candidateData,employerId }) {
...
console.log("This is EmployerId From Candidate Details",employerId)
    ...
    // else {
      try {
        const postData = await fetch('http://localhost:4500/api/candidate/applyJob', {
          ...
          body: JSON.stringify({candidateData:candidateData,employerId:employerId})
        })
            ...
            <div className="mt-10 sm:mx-auto sm:w-[50%]">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="block px-3 h-52 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                ...
                <div>
                  ...
                  <div className="mt-2 ">
                    <input
                      ...
                      autoComplete="current-password"
                      required
                      className=" px-3 block h-52 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      value={candidateData.previuosCompany}
                      id="Previous Company"
